...
<div class="container">
    ...
    <div class="contentheader border-bottom mb-4">
        Portfolio site
    </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <h5 class="card-title">AR Business Card</h5>
                        <div align="center" class="embed-responsive embed-responsive-16by9">
                            <video autoplay loop muted class="embed-responsive-item">
                            <source src="/vid/AR Business Card.mp4" type="video/mp4">
                            </video>
                        </div>
                    <p class="card-text">I made a simple business card AR app for the sales team of my current company, which they could show to potential clients to make them consider ways in which AR could be useful to them.</p>
                </div>
            </div>

            <div class="card mb-2">
                <div class="card-body">
                    <h5 class="card-title">Parallel world defence</h5>
                        <div align="center" class="embed-responsive embed-responsive-16by9">
                            <video autoplay loop muted class="embed-responsive-item">
                            <source src="/vid/splitty explodey cropped.mp4" type="video/mp4">
                            </video>
                        </div>
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <h5 class="card-title">Corridor Bijsturing</h5>
                        <div align="center" class="embed-responsive embed-responsive-16by9">
                            <video autoplay loop muted class="embed-responsive-item">
        ...
        <div class="col-sm-4">
                ...
                <div class="card-body">
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <img class="d-block w-100" src="/img/models/DSC_3601.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/models/DSC_3603.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/models/DSC_3136.JPG" alt="Third slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/models/DSC_4275.jpg" alt="Fourth slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/models/sw.jpg" alt="Fifth slide">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                            <img class="d-block w-100" src="/img/photos/DSC_6725.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/photos/DSC_5635.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/photos/DSC_6068.jpg" alt="Third slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/photos/DSC_7292.jpg" alt="Fourth slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/photos/DSC_7441.jpg" alt="Fifth slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/photos/DSC_7510.jpg" alt="Sixth slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/photos/DSC_3953.jpg" alt="Seventh slide">
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="/img/photos/DSC_4422.jpg" alt="Eigth slide">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <p class="card-text">日本語を独学してるから試験は受け取ったことないけど、日本にいる時日本語しか話さない日が多いので日常会話くらいは問題なくできる。弱点はカジュアルの話方と手書きは全く練習してないとこ。
                        いつもネット友達と話してるから今の状態は仕方ないと思うけど、日本の会社に仕事したら結構早めにちゃんとした日本語にもなれるはず。
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        and why they said whatever they did. 
                    </p>
                </div>
            </div>
            <div class="card mb-2">
